@include('partials.notify')
                            ...
                            <div data-v-676b993c class="flex-none">
                                <div
                                    class="flex justify-between items-center dash-footer"
                                    data-v-676b993c>
                                    <div class="foo-socialm" data-v-676b993c>
                                        <ul data-v-676b993c>
                                            <li data-v-676b993c>
                                                <a
                                                    href="https://www.facebook.com/Jumbo-Ticket-105467484785340"
                                                    target="_blank"
                                                    data-v-676b993c><i
                                            ...
                                            <li data-v-676b993c>
                                                <a
                                                    href="https://instagram.com/jumboticket"
                                                    target="_blank"
                                                    data-v-676b993c><i
                                            ...
                                            <li data-v-676b993c>
                                                <a
                                                    href="https://t.me/jumboticketchannel"
                                                    target="_blank"
                                                    data-v-676b993c><i
                                            ...
                                            <li data-v-676b993c>
                                                <a
                                                    href="https://vimeo.com/jumboticket"
                                                    target="_blank"
                                                    data-v-676b993c><i
                                            ...
                                            <li data-v-676b993c>
                                                <a
                                                    href="https://www.youtube.com/@jumboticketglobalfans"
                                                    target="_blank"
                                                    data-v-676b993c><i
        ...
        <iframe
            ...
            allow="microphone"
            style="display: none"></iframe><input type="file" id name="file"
            style="display: none" />
        <div data-v-2b23e28f>
            <div
                data-v-2b23e28f
        ...
        <div id="recorder_selected_root"></div>
      ...
      "
            ...
            <div id="goog-gt-vt" class="VIpgJd-yAWNEb-hvhgNd">
                ...
                <div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid ltr">
                    <div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid-B7I4Od ltr"
                        dir="ltr">
                        <div class="VIpgJd-yAWNEb-hvhgNd-UTujCb">Rate this
                            translation</div>
                        <div class="VIpgJd-yAWNEb-hvhgNd-eO9mKe">
                            Your feedback will be used to help improve Google
                            Translate
                        </div>
                    </div>
                    <div class="VIpgJd-yAWNEb-hvhgNd-xgov5 ltr">
                        <button
                            ...
                            aria-pressed="false">
                            <span id="goog-gt-thumbUpIcon"><svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    focusable="false"
                                ...
                                id="goog-gt-thumbUpIconFilled"><svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    focusable="false"
                                    class="VIpgJd-yAWNEb-hvhgNd-THI6Vb NMm5M">
                                    <path
                                        d="M21 7h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 0S7.08 6.85 7 7v13h11c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73V9c0-1.1-.9-2-2-2zM5 7H1v13h4V7z"></path></svg></span></button><button
                            ...
                            aria-pressed="false">
                            <span id="goog-gt-thumbDownIcon"><svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    focusable="false"
                                ...
                                id="goog-gt-thumbDownIconFilled"><svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    focusable="false"
                ...
                <div id="goog-gt-votingHiddenPane"
                    ...
                    <form
                        ...
                        <input
                            ...
                            type="text"
                            name="tl"
                            id="goog-gt-votingInputTrgLang" /><input
                            type="text"
                            name="query"
                            id="goog-gt-votingInputSrcText" /><input
                            type="text"
                            name="gtrans"
                            id="goog-gt-votingInputTrgText" /><input type="text"
                            name="vote" id="goog-gt-votingInputVote" />
                    </form>
        ...
        <div class="VIpgJd-ZVi9od-aZ2wEe-wOHMyf" style="display: none">
