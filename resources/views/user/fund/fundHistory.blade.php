<div class="px-[25px] py-[20px] flex-1">
    <div>
        <div class="bg-white px-6 py-6 rounded-lg mt-2 grid">
         <div data-v-c3a81764="" class="bloq-head"><h4 data-v-c3a81764="">Add Fund Report</h4><a data-v-c3a81764="" href="/buy-ticket" class=""> Report <i data-v-c3a81764="" class="bx bx-chevron-right"></i></a></div>
