            ...
            <form action="#" method="POST">
                <div class="flex flex-wrap -mx-3 mt-3 items-end">
                    <div class="w-full sm:w-1/2 lg:w-3/12 px-3 my-3">
                     <label for=""></label>
                    <select name="type" class="selectricBl bg-gray-50 border border-[#ECC762] px-4 py-2 h-[45px] rounded-lg outline-none shadow-none w-full flatpickr-input" >
                        <option value="">--SELECT--</option>
                        <option >Roi Bonus</option>
