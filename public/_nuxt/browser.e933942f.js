...
P.BYTE = new RegExp(kt, "g");
P.NUMERIC = new RegExp(pt, "g");
P.ALPHANUMERIC = new RegExp(Ft, "g");
    ...
    var t = {
        single_source_shortest_paths: function(i, o, r) {
            ...
            for (var u, a, l, B, w, f, m, y, I; !c.empty();) {
                ...
                for (l in w) w.hasOwnProperty(l) && (f = w[l], m = B + f, y = s[l], I = typeof s[l] > "u", (I || y > m) && (s[l] = m, c.push(l, m), n[l] = a))
            }
...
(function(e) {
    ...
    function y(h, E) {
        ...
        for (let p = 0; p < C.length; p++) g[C[p]].end = 0;
        return {
            map: g,
            table: d
        }
 ...
 Suggested mode is: ` + t.toString(g));
    ...
    e.fromArray = function(E) {
        return E.reduce(function(d, g) {
            return typeof g == "string" ? d.push(I(g, null)) : g.data && d.push(I(g.data, g.mode)), d
        }, [])
    }, e.fromString = function(E, d) {
        const g = B(E, c.isKanjiModeEnabled()),
            C = m(g),
            p = y(C, d),
...
function ge(e, t, i) {
    ...
    let g = 0,
        C, p;
    for (C = 0; C < h; C++)
        for (p = 0; p < s; p++) C < y[p].length && (d[g++] = y[p][C]);
    for (C = 0; C < w; C++)
        for (p = 0; p < s; p++) d[g++] = I[p][C];
    return d
}
...
dt.create = function(t, i) {
    ...
    let o = Z.M,
        r, n;
    return typeof i < "u" && (o = Z.from(i.errorCorrectionLevel, Z.M), r = Y.from(i.version), n = nt.from(i.maskPattern), i.toSJISFunc && Q.setToSJISFunction(i.toSJISFunc)), de(t, r, o, n)
};
var Mt = {},
    ct = {};
(function(e) {
...
Pt.render = function(t, i, o) {
    const r = he.getOptions(i),
        n = t.modules.size,
        s = t.modules.data,
        c = n + r.margin * 2,
        u = r.color.light.a ? "<path " + gt(r.color.light, "fill") + ' d="M0 0h' + c + "v" + c + 'H0z"/>' : "",
        a = "<path " + gt(r.color.dark, "stroke") + ' d="' + we(s, n, r.margin) + '"/>',
        l = 'viewBox="0 0 ' + c + " " + c + '"',
...
O.create = ot.create;
O.toCanvas = at.bind(null, St.render);
O.toDataURL = at.bind(null, St.renderToDataURL);
