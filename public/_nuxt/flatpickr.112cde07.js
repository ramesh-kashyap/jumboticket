...
function qe(a, r) {
    if (r(a)) return a;
    if (a.parentNode) return qe(a.parentNode, r)
}
...
function de(a, r) {
    ...
    if (navigator.userAgent.indexOf("MSIE 9.0") === -1 ? m.type = "number" : (m.type = "text", m.pattern = "\\d*"), r !== void 0)
        for (var M in r) m.setAttribute(M, r[M]);
...
var ke = function() {},
    ...
    ze = function(a) {
        ...
        return function(E, x, Z) {
            var y = Z || h;
            return e.formatDate !== void 0 && !M ? e.formatDate(E, x, y) : x.split("").map(function(F, N, Y) {
                return ne[F] && Y[N - 1] !== "\\" ? ne[F](E, y, e) : F !== "\\" ? F : ""
            }).join("")
        }
    },
    _e = function(a) {
        ...
        return function(d, M, E, x) {
            if (!(d !== 0 && !d)) {
                ...
                if (d instanceof Date) y = new Date(d.getTime());
                    ...
                    var N = M || (e || z).dateFormat,
                        Y = String(d).trim();
                    if (Y === "today") y = new Date, E = !0;
                        ...
                        y = !e || !e.noCalendar ? new Date(new Date().getFullYear(), 0, 1, 0, 0, 0, 0) : new Date(new Date().setHours(0, 0, 0, 0)), D.forEach(function(V) {
                            var J = V.fn,
                                he = V.val;
                            return y = J(y, he, Z) || y
                        }), y = ae ? y : void 0
                ...
                return E === !0 && y.setHours(0, 0, 0, 0), y
            }
        }
    };
...
function Te(a) {
    ...
    if (a.minDate !== void 0) {
        var h = a.minDate.getHours(),
            ...
            M = a.minDate.getSeconds();
        r < h && (r = h), r === h && e < d && (e = d), r === h && e === d && m < M && (m = a.minDate.getSeconds())
    }
    if (a.maxDate !== void 0) {
        var E = a.maxDate.getHours(),
            x = a.maxDate.getMinutes();
        r = Math.min(r, E), r === E && (e = Math.min(x, e)), r === E && e === x && (m = a.maxDate.getSeconds())
    }
    return {
        hours: r,
        minutes: e,
...
var k = globalThis && globalThis.__assign || function() {
    ...
    $e = globalThis && globalThis.__spreadArrays || function() {
        for (var a = 0, r = 0, e = arguments.length; r < e; r++) a += arguments[r].length;
        for (var m = Array(a), h = 0, r = 0; r < e; r++)
            for (var d = arguments[r], M = 0, E = d.length; M < E; M++, h++) m[h] = d[M];
        return m
    },
    Hn = 300;
...
function Ln(a, r) {
    ...
    function h() {
        e.element = e.input = a, e.isOpen = !1, un(), He(), pn(), mn(), m(), e.isMobile || pe(), me(), (e.selectedDates.length || e.config.noCalendar) && (e.config.enableTime && N(e.config.noCalendar ? e.latestSelectedDateObj : void 0), H(!1)), E();
        var n = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
        !e.isMobile && n && fe(), C("onReady")
    }
    ...
    function x(n) {
        if (e.selectedDates.length === 0) {
            var t = e.config.minDate === void 0 || O(new Date, e.config.minDate) >= 0 ? new Date : new Date(e.config.minDate.getTime()),
                i = Te(e.config);
        ...
        F(), H(), e._input.value !== o && e._debouncedChange()
    }
    ...
    function F() {
        if (!(e.hourElement === void 0 || e.minuteElement === void 0)) {
            ...
            var o = e.config.minTime !== void 0 || e.config.minDate && e.minDateHasTime && e.latestSelectedDateObj && O(e.latestSelectedDateObj, e.config.minDate, !0) === 0,
                l = e.config.maxTime !== void 0 || e.config.maxDate && e.maxDateHasTime && e.latestSelectedDateObj && O(e.latestSelectedDateObj, e.config.maxDate, !0) === 0;
            if (e.config.maxTime !== void 0 && e.config.minTime !== void 0 && e.config.minTime > e.config.maxTime) {
                var f = Ie(e.config.minTime.getHours(), e.config.minTime.getMinutes(), e.config.minTime.getSeconds()),
                    g = Ie(e.config.maxTime.getHours(), e.config.maxTime.getMinutes(), e.config.maxTime.getSeconds()),
                    s = Ie(n, t, i);
                if (s > g && s < f) {
                    var p = Pn(f);
                    n = p[0], t = p[1], i = p[2]
    ...
    function me() {
        ...
        var n = Ke(ln, 50);
        if (e._debouncedChange = Ke(j, Hn), e.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && D(e.daysContainer, "mouseover", function(i) {
                e.config.mode === "range" && le(_(i))
            }), D(e._input, "keydown", Ne), e.calendarContainer !== void 0 && D(e.calendarContainer, "keydown", Ne), !e.config.inline && !e.config.static && D(window, "resize", n), window.ontouchstart !== void 0 ? D(window.document, "touchstart", De) : D(window.document, "mousedown", De), D(window.document, "focus", De, {
                capture: !0
            }), e.config.clickOpens === !0 && (D(e._input, "focus", e.open), D(e._input, "click", e.open)), e.daysContainer !== void 0 && (D(e.monthNav, "click", bn), D(e.monthNav, ["keyup", "increment"], ae), D(e.daysContainer, "click", je)), e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0) {
            var t = function(i) {
                return _(i).select()
            };
            D(e.timeContainer, ["increment"], x), D(e.timeContainer, "blur", x, {
                capture: !0
            }), D(e.timeContainer, "click", R), D([e.hourElement, e.minuteElement], ["focus", "click"], t), e.secondElement !== void 0 && D(e.secondElement, "focus", function() {
    ...
    function L(n, t) {
        ...
        t && e.currentYear !== o && (C("onYearChange"), U()), t && (e.currentYear !== o || e.currentMonth !== l) && C("onMonthChange"), e.redraw()
    }
    ...
    function pe() {
        ...
        if (e.calendarContainer = v("div", "flatpickr-calendar"), e.calendarContainer.tabIndex = -1, !e.config.noCalendar) {
            ...
            e.rContainer = v("div", "flatpickr-rContainer"), e.rContainer.appendChild(Ae()), e.daysContainer || (e.daysContainer = v("div", "flatpickr-days"), e.daysContainer.tabIndex = -1), ie(), e.rContainer.appendChild(e.daysContainer), e.innerContainer.appendChild(e.rContainer), n.appendChild(e.innerContainer)
        }
    ...
    function J(n) {
        for (var t = n > 0 ? 0 : e.config.showMonths - 1, i = n > 0 ? e.config.showMonths : -1, o = t; o != i; o += n)
            for (var l = e.daysContainer.children[o], f = n > 0 ? 0 : l.children.length - 1, g = n > 0 ? l.children.length : -1, s = f; s != g; s += n) {
                var p = l.children[s];
                if (p.className.indexOf("hidden") === -1 && B(p.dateObj)) return p
            }
    }
    ...
    function he(n, t) {
        for (var i = n.className.indexOf("Month") === -1 ? n.dateObj.getMonth() : e.currentMonth, o = t > 0 ? e.config.showMonths : -1, l = t > 0 ? 1 : -1, f = i - e.currentMonth; f != o; f += l)
            for (var g = e.daysContainer.children[f], s = i - e.currentMonth === f ? n.$i + t : t < 0 ? g.children.length - 1 : 0, p = g.children.length, u = s; u >= 0 && u < p && u != (t > 0 ? p : -1); u += l) {
                var c = g.children[u];
                if (c.className.indexOf("hidden") === -1 && B(c.dateObj) && Math.abs(n.$i - u) >= Math.abs(t)) return V(c)
            }
        e.changeMonth(l), Q(J(l), 0)
    }

    function Q(n, t) {
        var i = d(),
            o = oe(i || document.body),
            l = n !== void 0 ? n : o ? i : e.selectedDateElem !== void 0 && oe(e.selectedDateElem) ? e.selectedDateElem : e.todayDateElem !== void 0 && oe(e.todayDateElem) ? e.todayDateElem : J(t > 0 ? 1 : -1);
        l === void 0 ? e._input.focus() : o ? he(l, t) : V(l)
    }
    ...
    function Ze(n, t) {
        ...
        for (u = 1; u <= l; u++, c++) f.appendChild(W("flatpickr-day", new Date(n, t, u), u, c));
        for (var b = l + 1; b <= 42 - i && (e.config.showMonths === 1 || c % 7 !== 0); b++, c++) f.appendChild(W("flatpickr-day " + p, new Date(n, t + 1, b % l), b, c));
    ...
    function Qe() {
        ...
        e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? i = v("span", "cur-month") : (e.monthsDropdownContainer = v("select", "flatpickr-monthDropdown-months"), e.monthsDropdownContainer.setAttribute("aria-label", e.l10n.monthAriaLabel), D(e.monthsDropdownContainer, "change", function(g) {
            var s = _(g),
                p = parseInt(s.value, 10);
            e.changeMonth(p - e.currentMonth), C("onMonthChange")
        }), U(), i = e.monthsDropdownContainer);
        var o = de("cur-year", {
                tabindex: "-1"
            }),
    ...
    function en() {
        ...
        if (e.minuteElement = o.getElementsByTagName("input")[0], e.hourElement.tabIndex = e.minuteElement.tabIndex = -1, e.hourElement.value = T(e.latestSelectedDateObj ? e.latestSelectedDateObj.getHours() : e.config.time_24hr ? n.hours : y(n.hours)), e.minuteElement.value = T(e.latestSelectedDateObj ? e.latestSelectedDateObj.getMinutes() : n.minutes), e.hourElement.setAttribute("step", e.config.hourIncrement.toString()), e.minuteElement.setAttribute("step", e.config.minuteIncrement.toString()), e.hourElement.setAttribute("min", e.config.time_24hr ? "0" : "1"), e.hourElement.setAttribute("max", e.config.time_24hr ? "23" : "12"), e.hourElement.setAttribute("maxlength", "2"), e.minuteElement.setAttribute("min", "0"), e.minuteElement.setAttribute("max", "59"), e.minuteElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(i), e.timeContainer.appendChild(t), e.timeContainer.appendChild(o), e.config.time_24hr && e.timeContainer.classList.add("time24hr"), e.config.enableSeconds) {
    ...
    function Fe() {
        if (e.weekdayContainer) {
            var n = e.l10n.firstDayOfWeek,
                t = $e(e.l10n.weekdays.shorthand);
            n > 0 && n < t.length && (t = $e(t.splice(n, t.length), t.splice(0, n)));
    ...
    function ve(n, t) {
        ...
        i < 0 && e._hidePrevMonthArrow === !0 || i > 0 && e._hideNextMonthArrow === !0 || (e.currentMonth += i, (e.currentMonth < 0 || e.currentMonth > 11) && (e.currentYear += e.currentMonth > 11 ? 1 : -1, e.currentMonth = (e.currentMonth + 12) % 12, C("onYearChange"), U()), ie(), C("onMonthChange"), se())
    }
    ...
    function De(n) {
        if (e.isOpen && !e.config.inline) {
            var t = _(n),
                ...
                l = !o && !i && !X(n.relatedTarget),
                f = !e.config.ignoredFocusElements.some(function(g) {
                    return g.contains(t)
                });
            l && f && (e.config.allowInput && e.setDate(e._input.value, !1, e.config.altInput ? e.config.altFormat : e.config.dateFormat), e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0 && e.input.value !== "" && e.input.value !== void 0 && x(), e.close(), e.config && e.config.mode === "range" && e.selectedDates.length === 1 && e.clear(!1))
        }
    }
    ...
    function re(n) {
        if (!(!n || e.config.minDate && n < e.config.minDate.getFullYear() || e.config.maxDate && n > e.config.maxDate.getFullYear())) {
            var t = n,
                i = e.currentYear !== t;
            e.currentYear = t || e.currentYear, e.config.maxDate && e.currentYear === e.config.maxDate.getFullYear() ? e.currentMonth = Math.min(e.config.maxDate.getMonth(), e.currentMonth) : e.config.minDate && e.currentYear === e.config.minDate.getFullYear() && (e.currentMonth = Math.max(e.config.minDate.getMonth(), e.currentMonth)), i && (e.redraw(), C("onYearChange"), U())
        }
    }
    ...
    function B(n, t) {
        ...
        if (e.config.minDate && o && O(o, e.config.minDate, t !== void 0 ? t : !e.minDateHasTime) < 0 || e.config.maxDate && o && O(o, e.config.maxDate, t !== void 0 ? t : !e.maxDateHasTime) > 0) return !1;
        if (!e.config.enable && e.config.disable.length === 0) return !0;
        if (o === void 0) return !1;
        for (var l = !!e.config.enable, f = (i = e.config.enable) !== null && i !== void 0 ? i : e.config.disable, g = 0, s = void 0; g < f.length; g++) {
            if (s = f[g], typeof s == "function" && s(o)) return l;
            if (s instanceof Date && o !== void 0 && s.getTime() === o.getTime()) return l;
            if (typeof s == "string") {
                var p = e.parseDate(s, void 0, !0);
                return p && p.getTime() === o.getTime() ? l : !l
            } else if (typeof s == "object" && o !== void 0 && s.from && s.to && o.getTime() >= s.from.getTime() && o.getTime() <= s.to.getTime()) return l
        }
        return !l
    }
    ...
    function Ne(n) {
        ...
        if (n.keyCode === 13 && i) {
            ...
            switch (n.keyCode) {
                ...
                case 39:
                    if (!g && !i) {
                        ...
                        if (e.daysContainer !== void 0 && (o === !1 || s && oe(s))) {
                            ...
                            n.ctrlKey ? (n.stopPropagation(), ve(p), Q(J(1), 0)) : Q(void 0, p)
                        }
                ...
                case 40:
                    ...
                    e.daysContainer && t.$i !== void 0 || t === e.input || t === e.altInput ? n.ctrlKey ? (n.stopPropagation(), re(e.currentYear - u), Q(J(1), 0)) : g || Q(void 0, u * 7) : t === e.currentYearElement ? re(e.currentYear - u) : e.config.enableTime && (!g && e.hourElement && e.hourElement.focus(), x(n), e._debouncedChange());
                    break;
                case 9:
                    if (g) {
                        var c = [e.hourElement, e.minuteElement, e.secondElement, e.amPM].concat(e.pluginElements).filter(function(S) {
                                return S
                            }),
                            b = c.indexOf(t);
                        if (b !== -1) {
        ...
        if (e.amPM !== void 0 && t === e.amPM) switch (n.key) {
            ...
            case e.l10n.amPM[0].charAt(0).toLowerCase():
                e.amPM.textContent = e.l10n.amPM[0], F(), H();
                break;
            case e.l10n.amPM[1].charAt(0):
            case e.l10n.amPM[1].charAt(0).toLowerCase():
                e.amPM.textContent = e.l10n.amPM[1], F(), H();
                break
        }(i || X(t)) && C("onKeyDown", n)
    }
    ...
    function le(n, t) {
        if (t === void 0 && (t = "flatpickr-day"), !(e.selectedDates.length !== 1 || n && (!n.classList.contains(t) || n.classList.contains("flatpickr-disabled")))) {
            for (var i = n ? n.dateObj.getTime() : e.days.firstElementChild.dateObj.getTime(), o = e.parseDate(e.selectedDates[0], void 0, !0).getTime(), l = Math.min(i, e.selectedDates[0].getTime()), f = Math.max(i, e.selectedDates[0].getTime()), g = !1, s = 0, p = 0, u = l; u < f; u += Yn.DAY) B(new Date(u), !0) || (g = g || u > l && u < f, u < o && (!s || u > s) ? s = u : u > o && (!p || u < p) && (p = u));
            ...
            c.forEach(function(b) {
                var P = b.dateObj,
                    ...
                    ee = s > 0 && S < s || p > 0 && S > p;
                if (ee) {
                    b.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach(function(q) {
                ...
                ["startRange", "inRange", "endRange", "notAllowed"].forEach(function(q) {
                    b.classList.remove(q)
                }), n !== void 0 && (n.classList.add(i <= e.selectedDates[0].getTime() ? "startRange" : "endRange"), o < i && S === o ? b.classList.add("startRange") : o > i && S === o && b.classList.add("endRange"), S >= s && (p === 0 || S <= p) && Nn(S, o, i) && b.classList.add("inRange"))
            })
        }
    }
    ...
    function fn(n, t) {
        ...
        var o = e.isOpen;
        e.isOpen = !0, o || (e.calendarContainer.classList.add("open"), e._input.classList.add("active"), C("onOpen"), fe(t)), e.config.enableTime === !0 && e.config.noCalendar === !0 && e.config.allowInput === !1 && (n === void 0 || !e.timeContainer.contains(n.relatedTarget)) && setTimeout(function() {
    ...
    function un() {
        var n = ["wrap", "weekNumbers", "allowInput", "allowInvalidPreload", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"],
            t = k(k({}, JSON.parse(JSON.stringify(a.dataset || {}))), r),
            i = {};
        ...
        for (var s = 0; s < n.length; s++) e.config[n[s]] = e.config[n[s]] === !0 || e.config[n[s]] === "true";
        Ee.filter(function(c) {
            return e.config[c] !== void 0
        }).forEach(function(c) {
            e.config[c] = xe(e.config[c] || []).map(M)
        }), e.isMobile = !e.config.disableMobile && !e.config.inline && e.config.mode === "single" && !e.config.disable.length && !e.config.enable && !e.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
        for (var s = 0; s < e.config.plugins.length; s++) {
            var p = e.config.plugins[s](e) || {};
            for (var u in p) Ee.indexOf(u) > -1 ? e.config[u] = xe(p[u]).map(M).concat(e.config[u]) : typeof t[u] > "u" && (e.config[u] = p[u])
        }
        t.altInputClass || (e.config.altInputClass = Ye().className + " " + e.config.altInputClass), C("onParseConfig")
    }
    ...
    function He() {
        typeof e.config.locale != "object" && typeof w.l10ns[e.config.locale] > "u" && e.config.errorHandler(new Error("flatpickr: invalid locale " + e.config.locale)), e.l10n = k(k({}, w.l10ns.default), typeof e.config.locale == "object" ? e.config.locale : e.config.locale !== "default" ? w.l10ns[e.config.locale] : void 0), K.D = "(" + e.l10n.weekdays.shorthand.join("|") + ")", K.l = "(" + e.l10n.weekdays.longhand.join("|") + ")", K.M = "(" + e.l10n.months.shorthand.join("|") + ")", K.F = "(" + e.l10n.months.longhand.join("|") + ")", K.K = "(" + e.l10n.amPM[0] + "|" + e.l10n.amPM[1] + "|" + e.l10n.amPM[0].toLowerCase() + "|" + e.l10n.amPM[1].toLowerCase() + ")";
        var n = k(k({}, r), JSON.parse(JSON.stringify(a.dataset || {})));
        n.time_24hr === void 0 && w.defaultConfig.time_24hr === void 0 && (e.config.time_24hr = e.l10n.time_24hr), e.formatDate = ze(e), e.parseDate = _e({
            config: e.config,
            l10n: e.l10n
        })
    }
    ...
    function fe(n) {
        ...
        if (e.calendarContainer !== void 0) {
            ...
            var t = n || e._positionElement,
                i = Array.prototype.reduce.call(e.calendarContainer.children, function(Tn, Sn) {
                ...
                p = window.innerHeight - s.bottom,
                u = f === "above" || f !== "below" && p < i && s.top > i,
                c = window.pageYOffset + s.top + (u ? -i - 2 : t.offsetHeight + 2);
            if (I(e.calendarContainer, "arrowTop", !u), I(e.calendarContainer, "arrowBottom", u), !e.config.inline) {
                var b = window.pageXOffset + s.left,
                    P = !1,
                    S = !1;
                g === "center" ? (b -= (o - s.width) / 2, P = !0) : g === "right" && (b -= o - s.width, S = !0), I(e.calendarContainer, "arrowLeft", !P && !S), I(e.calendarContainer, "arrowCenter", P), I(e.calendarContainer, "arrowRight", S);
                var ee = window.document.body.offsetWidth - (window.pageXOffset + s.right),
                    q = b + o > window.document.body.offsetWidth,
                    Mn = ee + o > window.document.body.offsetWidth;
                if (I(e.calendarContainer, "rightMost", q), !e.config.static)
                    if (e.calendarContainer.style.top = c + "px", !q) e.calendarContainer.style.left = b + "px", e.calendarContainer.style.right = "auto";
                    else if (!Mn) e.calendarContainer.style.left = "auto", e.calendarContainer.style.right = ee + "px";
                else {
                    var ye = sn();
                    if (ye === void 0) return;
                    var wn = window.document.body.offsetWidth,
                        yn = Math.max(0, wn / 2 - o / 2),
                        En = ".flatpickr-calendar.centerMost:before",
                        xn = ".flatpickr-calendar.centerMost:after",
                        kn = ye.cssRules.length,
                        In = "{left:" + s.left + "px;right:auto;}";
                    I(e.calendarContainer, "rightMost", !1), I(e.calendarContainer, "centerMost", !0), ye.insertRule(En + "," + xn + In, kn), e.calendarContainer.style.left = yn + "px", e.calendarContainer.style.right = "auto"
                }
            }
        }
    }
    ...
    function Le() {
        e.config.noCalendar || e.isMobile || (U(), se(), ie())
    }
    ...
    function je(n) {
        ...
        if (i !== void 0) {
            ...
            } else e.config.mode === "range" && (e.selectedDates.length === 2 && e.clear(!1, !1), e.latestSelectedDateObj = l, e.selectedDates.push(l), O(l, e.selectedDates[0], !0) !== 0 && e.selectedDates.sort(function(c, b) {
                return c.getTime() - b.getTime()
            }));
            if (F(), f) {
                var s = e.currentYear !== l.getFullYear();
                e.currentYear = l.getFullYear(), e.currentMonth = l.getMonth(), s && (C("onYearChange"), U()), C("onMonthChange")
            }
            if (se(), ie(), H(), !f && e.config.mode !== "range" && e.config.showMonths === 1 ? V(o) : e.selectedDateElem !== void 0 && e.hourElement === void 0 && e.selectedDateElem && e.selectedDateElem.focus(), e.hourElement !== void 0 && e.hourElement !== void 0 && e.hourElement.focus(), e.config.closeOnSelect) {
    ...
    function dn(n, t) {
        if (n !== null && typeof n == "object") {
            ...
            for (var i in n) ue[i] !== void 0 && ue[i].forEach(function(o) {
                return o()
            })
        } else e.config[n] = t, ue[n] !== void 0 ? ue[n].forEach(function(o) {
            return o()
        }) : Ee.indexOf(n) > -1 && (e.config[n] = xe(t));
        e.redraw(), H(!0)
    }
    ...
    function gn(n, t, i) {
        ...
        Re(n, i), e.latestSelectedDateObj = e.selectedDates[e.selectedDates.length - 1], e.redraw(), L(void 0, t), N(), e.selectedDates.length === 0 && e.clear(!1), H(t), t && C("onChange")
    }
    ...
    function hn() {
        ...
        D(e.mobileInput, "change", function(t) {
            e.setDate(_(t).value, !1, e.mobileFormatStr), C("onChange"), C("onClose")
        })
    }
    ...
    function C(n, t) {
        if (e.config !== void 0) {
            ...
            n === "onChange" && (e.input.dispatchEvent(Ce("change")), e.input.dispatchEvent(Ce("input")))
        }
    }
    ...
    function Me(n) {
        for (var t = 0; t < e.selectedDates.length; t++) {
            ...
            if (i instanceof Date && O(i, n) === 0) return "" + t
        }
        return !1
    }
    ...
    function H(n) {
        n === void 0 && (n = !0), e.mobileInput !== void 0 && e.mobileFormatStr && (e.mobileInput.value = e.latestSelectedDateObj !== void 0 ? e.formatDate(e.latestSelectedDateObj, e.mobileFormatStr) : ""), e.input.value = we(e.config.dateFormat), e.altInput !== void 0 && (e.altInput.value = we(e.config.altFormat)), n !== !1 && C("onValueUpdate")
    }
    ...
    function Cn(n) {
        ...
        if (typeof o.value < "u" && o.value.length === 2) {
            var c = o === e.hourElement,
                b = o === e.minuteElement;
            u < l ? (u = f + u + A(!c) + (A(c) && A(!e.amPM)), b && $(void 0, -1, e.hourElement)) : u > f && (u = o === e.hourElement ? u - f - A(!e.amPM) : l, b && $(void 0, 1, e.hourElement)), e.amPM && c && (g === 1 ? u + s === 23 : Math.abs(u - s) > g) && (e.amPM.textContent = e.l10n.amPM[A(e.amPM.textContent === e.l10n.amPM[0])]), o.value = T(u)
        }
    }
    return h(), e
}
...
function G(a, r) {
    for (var e = Array.prototype.slice.call(a).filter(function(M) {
        ...
        try {
            ...
            d._flatpickr !== void 0 && (d._flatpickr.destroy(), d._flatpickr = void 0), d._flatpickr = Ln(d, r || {}), m.push(d._flatpickr)
        } catch (M) {
            console.error(M)
        }
    }
...
w.localize = function(a) {
    w.l10ns.default = k(k({}, w.l10ns.default), a)
};
w.setDefaults = function(a) {
    w.defaultConfig = k(k({}, w.defaultConfig), a)
};
w.parseDate = _e({});
w.formatDate = ze({});
w.compareDates = O;
...
typeof window < "u" && (window.flatpickr = w);
const Ge = ["onChange", "onClose", "onDestroy", "onMonthChange", "onOpen", "onYearChange"],
    jn = ["onValueUpdate", "onDayCreate", "onParseConfig", "onReady", "onPreCalendarPosition", "onKeyDown"];
...
const Ue = [...Ge, ...jn],
    ...
    Bn = _n({
        ...
        emits: ["blur", "update:modelValue", ...Ue.map(Ve)],
        props: {
            modelValue: {
        ...
        mounted() {
            this.fp || (this.fp = w(this.getElem(), this.prepareConfig()), this.fpInput().addEventListener("blur", this.onBlur), this.$watch("disabled", this.watchDisabled, {
                immediate: !0
            }))
        },
        methods: {
            prepareConfig() {
                ...
                this.events.forEach(e => {
                    let m = w.defaultConfig[e] || [],
                        h = (...d) => {
                            this.$emit(Ve(e), ...d)
                        };
                    a[e] = Je(a[e] || []).concat(m, h)
                });
                const r = this.onClose.bind(this);
                return a.onClose = Je(a.onClose || []).concat(r), a.defaultDate = this.modelValue || a.defaultDate, a
            },
            getElem() {
            ...
            onInput(a) {
                const r = a.target;
                An().then(() => {
                    this.$emit("update:modelValue", Se(r.value))
                })
            },
            fpInput() {
            ...
            onBlur(a) {
                this.$emit("blur", Se(a.target.value))
            },
            onClose(a, r) {
        ...
        watch: {
            ...
            modelValue(a) {
                var r;
                !this.$el || a === Se(this.$el.value) || (r = this.fp) === null || r === void 0 || r.setDate(a, !0)
            }
        },
        beforeUnmount() {
